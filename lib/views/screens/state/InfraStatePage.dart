...
import 'package:govunity_connect/screens/state/infraLinkState.dart';
            ...
            return ListTile(
              ...
              title: Card(
                ...
                child: Padding(
                  ...
                  child: Text(
                    pro.isGujarati
                        ? dataWWSchemes[index].titleG
                        : pro.isHindi
                            ? dataWWSchemes[index].titleH
                            : dataWWSchemes[index].title,
                    style: GoogleFonts.raleway(
              ...
              trailing: IconButton(
                onPressed: () {
                  setState(() {
                    dataWWSchemes[index].isFavorited =
                        !dataWWSchemes[index].isFavorited;
                  });
                },
                icon: Icon(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AgricultureDetailPage(dataWWSchemes[index]),
                  ),
                );
              },
            );
