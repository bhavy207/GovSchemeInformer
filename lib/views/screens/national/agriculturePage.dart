              ...
              return ListTile(
                ...
                title: Card(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      pro.isGujarati
                          ? data1Schemes[index].titleG
                          : pro.isHindi
                              ? data1Schemes[index].titleH
                              : data1Schemes[index].title,
                      style: GoogleFonts.raleway(
                        fontWeight: FontWeight.bold,
                        fontSize: 19,
                      ),
                ...
                trailing: IconButton(
                  onPressed: () {
                    setState(() {
                      data1Schemes[index].isFavorited =
                          !data1Schemes[index].isFavorited;
                    });
                  },
                  icon: Icon(
                ...
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) =>
                          AgricultureDetailPage(data1Schemes[index]),
                    ),
                  );
                },
              );
