            ...
            return ListTile(
              ...
              title: Card(
                ...
                child: Padding(
                  ...
                  child: Text(
                    pro.isGujarati
                        ? edata2Schemes[index].titleG
                        : pro.isHindi
                            ? edata2Schemes[index].titleH
                            : edata2Schemes[index].title,
                    style: GoogleFonts.raleway(
              ...
              trailing: IconButton(
                onPressed: () {
                  setState(() {
                    edata2Schemes[index].isFavorited =
                        !edata2Schemes[index].isFavorited;
                  });
                },
                icon: Icon(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        AgricultureDetailPage(edata2Schemes[index]),
                  ),
                );
              },
            );
